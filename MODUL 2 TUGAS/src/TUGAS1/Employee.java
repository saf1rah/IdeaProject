package TUGAS1; //setelah di refactor
...
public class Employee {
    ...
    public void applyBonus() {
        salary += calculateBonus();  //setelah dilakukan refactoring inline variable
        System.out.println("Bonus applied! New salary: " + salary);
    }

    //setelah di refactor dari applyBonus, hitung gaji berdasarkan salary dan bonus rate
